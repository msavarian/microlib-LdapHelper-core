...
{
    public class LdapBaseSigninManager : SignInManager<LdapIdentityUser>
    {
        public LdapBaseSigninManager(
            LdapBaseUserManager userManager,
            IHttpContextAccessor contextAccessor,
            IUserClaimsPrincipalFactory<LdapIdentityUser> claimsFactory,
            IOptions<IdentityOptions> optionsAccessor,
            ILogger<LdapBaseSigninManager> logger,
